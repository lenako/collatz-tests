...
TEST(Collatz, cycle_1){
    const int v = calculate_cycle_length(10);
    ASSERT_EQ(7, v);
}

TEST(Collatz, cycle_2){
    const int v = calculate_cycle_length(20);
    ASSERT_EQ(8, v);
}

TEST(Collatz, cycle_3){
    const int v = calculate_cycle_length(37);
    ASSERT_EQ(22, v);
}

TEST(Collatz, cycle_4){
    const int v = calculate_cycle_length(1);
    ASSERT_EQ(1, v);
}

TEST(Collatz, cycle_5){
    const int v = calculate_cycle_length(89);
    ASSERT_EQ(31, v);
}
...
TEST(Collatz, eval_4) {
    const int v = collatz_eval(900, 905);
    ASSERT_EQ(117, v);}
