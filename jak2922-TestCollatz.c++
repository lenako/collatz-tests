...
TEST(Collatz, read_2) {
    std::istringstream r("1876 923486\n");
    const std::pair<int, int> p = collatz_read(r);
    ASSERT_EQ(  1876, p.first);
    ASSERT_EQ(923486, p.second);}
...
TEST(Collatz, single_1) {
    const int v = collatz_single(5);
    ASSERT_EQ(6, v);
}

TEST(Collatz, single_2) {
    const int v = collatz_single(1);
    ASSERT_EQ(1, v);
}

TEST(Collatz, single_3) {
    const int v = collatz_single(2);
    ASSERT_EQ(2, v);
}

TEST(Collatz, single_4) {
    const int v = collatz_single(5);
    ASSERT_EQ(6, v);
}

TEST(Collatz, single_5) {
    const int v = collatz_single(999999);
    ASSERT_EQ(259, v);
}
...
TEST(Collatz, solve_2) {
    std::istringstream r("666 777\n");
    std::ostringstream w;
    collatz_solve(r, w);
    ASSERT_EQ("666 777 171\n", w.str());}
