...
TEST(Collatz, eval_7)
{
    const int v = collatz_eval(999999, 999000);
    ASSERT_EQ(396, v);
}   
...
{
    std::ostringstream w;
    collatz_print(w, 9, 684, 39075);
    ASSERT_EQ("9 684 39075\n", w.str());
}

TEST(Collatz, print3)
{
    std::ostringstream w;
    collatz_print(w, 9372, 75639, 5015);
    ASSERT_EQ("9372 75639 5015\n", w.str());
}
