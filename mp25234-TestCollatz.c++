...
TEST(Collatz, read_multiline) {
    std::istringstream r("1000 1000000\n2 20\n");
    const std::pair<int, int> p = collatz_read(r);
...
TEST(Collatz, read_max_int) {
    std::istringstream r("-2147483648 2147483647\n");
    const std::pair<int, int> p = collatz_read(r);
    ASSERT_EQ(-2147483648, p.first);
...
TEST(Collatz, eval_inverted) {
    const int v = collatz_eval(10, 1);
    ASSERT_EQ(20, v);}

TEST(Collatz, eval_inverted_2) {
    const int v = collatz_eval(1000, 900);
    ASSERT_EQ(174, v);}

TEST(Collatz, eval_inverted_3) {
    const int v = collatz_eval(210, 201);
    ASSERT_EQ(89, v);}

TEST(Collatz, eval_equal) {
    const int v = collatz_eval(22, 22);
    ASSERT_EQ(16, v);}

TEST(Collatz, eval_off_one) {
...
TEST(Collatz, print_2) {
    std::ostringstream w;
    collatz_print(w, -100, 1000001, 12345);
    ASSERT_EQ("-100 1000001 12345\n", w.str());}
