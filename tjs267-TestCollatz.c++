...
TEST(Collatz, eval_5) {
    const int v = collatz_eval(999000, 999999);
    ASSERT_EQ(396, v);}

TEST(Collatz, eval_6) {
    const int v = collatz_eval(600, 1800);
    ASSERT_EQ(182, v);}

TEST(Collatz, eval_7) {
    const int v = collatz_eval(1, 200000);
    ASSERT_EQ(383, v);}
...
TEST(Collatz, print_2) {
    std::ostringstream w;
    collatz_print(w, 0, -80, 20);
    ASSERT_EQ("0 -80 20\n", w.str());}

TEST(Collatz, print_3) {
    std::ostringstream w;
    collatz_print(w, -6, 0, 20);
    ASSERT_EQ("-6 0 20\n", w.str());}

TEST(Collatz, print_4) {
    std::ostringstream w;
    collatz_print(w, 56, 111, 999999);
    ASSERT_EQ("56 111 999999\n", w.str());}
