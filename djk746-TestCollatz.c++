...
{
  const int v = collatz_cycle_length(201);
  ASSERT_EQ(19, v);
}

TEST(Collatz, cycle_length_4)
{
  const int v = collatz_cycle_length(900);
  ASSERT_EQ(55, v);
}

TEST(Collatz, cycle_length_5)
{
  const int v = collatz_cycle_length(134335);
  ASSERT_EQ(251, v);
}

TEST(Collatz, cycle_length_6)
{
  const int v = collatz_cycle_length(134379);
  ASSERT_EQ(256, v);
}
...
TEST(Collatz, eval_5) {
    const int v = collatz_eval(134251, 134501);
    ASSERT_EQ(256, v);}
