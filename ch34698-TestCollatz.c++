...
// ----
// Charlina's read tests
// ----

TEST(Collatz, read_c1) 
{
...
TEST(Collatz, read_c4)
{
    std::istringstream r("10 8\n");
    const std::pair<int, int> p = collatz_read(r);
    ASSERT_EQ(10, p.first);
...
// ----
// Charlina's eval tests
// ----

TEST(Collatz, eval_c1) {
    const int v = collatz_eval(1, 2);
    ASSERT_EQ(2, v);}

TEST(Collatz, eval_c2) {
    const int v = collatz_eval(10, 5);
    ASSERT_EQ(20, v);}

TEST(Collatz, eval_c3) {
...
// ----
// Charlina's print tests
// ----

TEST(Collatz, print_c1) {
    std::ostringstream w;
    collatz_print(w, 1, 1, 1);
    ASSERT_EQ("1 1 1\n", w.str());}

TEST(Collatz, print_c2) {
    std::ostringstream w;
    collatz_print(w, 0, 0, 0);
    ASSERT_EQ("0 0 0\n", w.str());}

TEST(Collatz, print_c3) {
    std::ostringstream w;
    collatz_print(w, 1, 10, 20);
    ASSERT_EQ("1 10 20\n", w.str());}
...
// ----
// Charlina's solve tests
// ----

TEST(Collatz, solve_c1) {
    std::istringstream r("1 1\n1 2\n10 10\n20 21\n");
    std::ostringstream w;
    collatz_solve(r, w);
    ASSERT_EQ("1 1 1\n1 2 2\n10 10 7\n20 21 8\n", w.str());}

TEST(Collatz, solve_c2) {
    std::istringstream r("1 5\n5 6\n7 8\n10 11\n");
    std::ostringstream w;
    collatz_solve(r, w);
    ASSERT_EQ("1 5 8\n5 6 9\n7 8 17\n10 11 15\n", w.str());}

TEST(Collatz, solve_c3) {
    std::istringstream r("300 350\n350 400\n400 450\n450 500\n");
    std::ostringstream w;
    collatz_solve(r, w);
    ASSERT_EQ("300 350 144\n350 400 126\n400 450 134\n450 500 142\n", w.str());}
