...
TEST(Collatz, read_3) {
    std::istringstream r("42500 30000\n");
    const std::pair<int, int> p = collatz_read(r);
    ASSERT_EQ( 42500, p.first);
    ASSERT_EQ( 30000, p.second);}
// ----
// eval
// ----
...
TEST(Collatz, print_2) {
    std::ostringstream w;
    collatz_print(w, 10000, 10, 20);
    ASSERT_EQ("10000 10 20\n", w.str());}

TEST(Collatz, print_3) {
    std::ostringstream w;
    collatz_print(w, 10000.0, 10.0, 20.0);
    ASSERT_EQ("10000 10 20\n", w.str());}
