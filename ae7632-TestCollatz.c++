...
// -----
// new unit tests for auxiliary functions round_up and round_down
// -----

TEST(Collatz, round_up_1) {
    const int v = 1000;
    const int m = 1000;

    ASSERT_EQ(round_up(v, m), 1000);}

TEST(Collatz, round_up_2) {
    const int v =  999;
    const int m = 1000;

    ASSERT_EQ(round_up(v, m), 1000);}

TEST(Collatz, round_up_3) {
    const int v = 1001;
    const int m = 1000;

    ASSERT_EQ(round_up(v, m), 2000);}

TEST(Collatz, round_down_1) {
    const int v = 1000;
    const int m = 1000;

    ASSERT_EQ(round_down(v, m), 1000);}

TEST(Collatz, round_down_2) {
    const int v =  999;
    const int m = 1000;

    ASSERT_EQ(round_down(v, m), 0);}

TEST(Collatz, round_down_3) {
    const int v = 1001;
    const int m = 1000;
