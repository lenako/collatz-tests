...
TEST(CollatzDeathTest, eval_bad_input_1) { 
    ASSERT_DEATH(collatz_eval(0,1), "");}

TEST(CollatzDeathTest, eval_bad_input_2) {
    ASSERT_DEATH(collatz_eval(-1,1000), "");}

TEST(Collatz, eval_8) {
    const int v = collatz_eval(1);
    ASSERT_EQ(1, v);}

TEST(Collatz, eval_9) {
    const int v = collatz_eval(10001);
    ASSERT_EQ(180, v);}

TEST(CollatzDeathTest, eval_bad_input_3) { 
    ASSERT_DEATH(collatz_eval(0), "");}

TEST(CollatzDeathTest, eval_bad_input_4) {
    ASSERT_DEATH(collatz_eval(-1), "");}
