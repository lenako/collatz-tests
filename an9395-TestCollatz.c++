...
TEST(Collatz, find_cycle_length_1) {
    const int v = find_cycle_length(27);
    ASSERT_EQ(112, v);}

TEST(Collatz, find_cycle_length_2) {
    const int v = find_cycle_length(1);
    ASSERT_EQ(1, v);}

TEST(Collatz, find_cycle_length_3) {
    const int v = find_cycle_length(22);
    ASSERT_EQ(16, v);}
