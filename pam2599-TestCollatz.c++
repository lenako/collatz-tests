...
TEST(Collatz, eval_single_1) {
    const int v = collatz_eval(9);
    ASSERT_EQ(20, v);
}

TEST(Collatz, eval_single_2) {
    const int v = collatz_eval(171);
    ASSERT_EQ(125, v);
}

TEST(Collatz, eval_single_3) {
    const int v = collatz_eval(206);
    ASSERT_EQ(89, v);
}

TEST(Collatz, eval_single_4) {
    const int v = collatz_eval(937);
    ASSERT_EQ(174, v);
}

TEST(Collatz, eval_range_1) {
    const int v = collatz_eval(1, 10);
    ASSERT_EQ(20, v);
}

TEST(Collatz, eval_range_2) {
    const int v = collatz_eval(100, 200);
    ASSERT_EQ(125, v);
}

TEST(Collatz, eval_range_3) {
    const int v = collatz_eval(201, 210);
    ASSERT_EQ(89, v);
}

TEST(Collatz, eval_range_4) {
